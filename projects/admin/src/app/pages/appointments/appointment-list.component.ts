  ...
  template: `
    <div class="p-6 max-w-7xl mx-auto">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Appointments & Consultations</h1>
      </div>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr *ngFor="let apt of appointments()">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <select [ngModel]="apt.status" (ngModelChange)="updateStatus(apt.id, $event)" class="text-sm border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
