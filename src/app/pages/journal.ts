    ...
    <div class="min-h-screen bg-surface">
      ...
      <div class="bg-diamond-50 border-b border-diamond-200 section-padding">
        <div class="container-luxury text-center">
          ...
          <p class="text-lg text-ink max-w-2xl mx-auto">
      ...
      <div class="container-luxury section-padding">
        <div class="relative rounded-2xl overflow-hidden shadow-xl group cursor-pointer h-[500px]">
          <div class="absolute inset-0 bg-surface">
             ...
             <div class="w-full h-full bg-gradient-to-r from-surface to-surface opacity-50"></div>
          </div>
          <div class="absolute bottom-0 left-0 p-8 md:p-12 text-surface max-w-3xl">
            <span class="bg-gold-500 text-surface text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4 inline-block">Featured Guide</span>
            ...
            <p class="text-lg text-ink mb-6">Everything you need to know about the 4Cs, metal choices, and finding the perfect style for your partner.</p>
      ...
      <div class="container-luxury pb-24">
        <div class="mb-16 bg-surface p-8 md:p-12 rounded-2xl border border-ink shadow-sm">
          <div class="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div class="w-full md:w-2/3">
              <h2 class="text-3xl font-display font-bold text-ink mb-4">About the Founders: A Jaipur Legacy</h2>
              <div class="space-y-4 text-ink leading-relaxed text-lg">
                <p>
                ...
                <div class="pt-4 border-t border-ink">
                  <h3 class="font-bold text-ink mb-2">Why Choose Caratloop?</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <article class="card card-hover group cursor-pointer">
            ...
            <div class="p-6">
              ...
              <h3 class="text-xl font-bold text-ink mb-3 group-hover:text-gold-600 transition-colors">How to Care for Your Emeralds</h3>
              <p class="text-ink text-sm mb-4 line-clamp-2">Emeralds are precious but require special care. Learn the do's and don'ts of cleaning and storing.</p>
          ...
          <article class="card card-hover group cursor-pointer">
            ...
            <div class="p-6">
              ...
              <h3 class="text-xl font-bold text-ink mb-3 group-hover:text-gold-600 transition-colors">Top 5 Trends for 2025</h3>
              <p class="text-ink text-sm mb-4 line-clamp-2">From vintage revivals to colorful stones, discover what's trending in the world of high jewelry.</p>
              <span class="text-sm font-semibold underline">Read More</span>
            </div>
          </article>
          ...
          <article class="card card-hover group cursor-pointer">
            ...
            <div class="p-6">
              ...
              <h3 class="text-xl font-bold text-ink mb-3 group-hover:text-gold-600 transition-colors">Platinum vs. White Gold</h3>
              <p class="text-ink text-sm mb-4 line-clamp-2">Understanding the differences in durability, cost, and maintenance to make the right choice.</p>
              <span class="text-sm font-semibold underline">Read More</span>
            </div>
          </article>
        </div>
