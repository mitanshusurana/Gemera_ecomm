    ...
    <div class="min-h-screen bg-[#f5f5f7] font-sans text-[#1d1d1f]">
      <div class="max-w-[1080px] mx-auto px-6 md:px-12 py-16 md:py-24">
        <div class="max-w-md mx-auto">
          <div class="bg-white border border-[#e0e0e0] rounded-[18px] p-8 md:p-10 text-center animate-fadeIn">
            ...
            <form (ngSubmit)="submit()" #forgotForm="ngForm" class="space-y-6 text-left">
              ...
              <div class="text-center text-sm mt-4">
                <a routerLink="/login" class="text-[#D4AF37] hover:underline font-medium">
                  &larr; Back to Login
                </a>
              </div>
            </form>
            ...
            <div *ngIf="successMessage()" class="mt-6 bg-green-50 border border-green-200 rounded-[12px] p-4 text-green-600 text-sm">
              {{ successMessage() }}
            </div>
          </div>
        </div>
