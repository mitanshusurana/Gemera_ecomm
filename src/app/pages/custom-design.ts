  ...
  template: `
    <div class="min-h-screen bg-neutral-50 py-16 px-4 pt-32">
      <div class="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-xl">
        <h1 class="text-4xl font-serif font-bold text-primary-900 mb-4 text-center">Design Your Own</h1>
        ...
        <form [formGroup]="inquiryForm" (ngSubmit)="submitInquiry()" class="space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" formControlName="name" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" required />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
              <input type="email" formControlName="email" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" required />
            </div>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Phone *</label>
            <input type="tel" formControlName="phone" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" required />
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Design Concept *</label>
            <textarea formControlName="concept" rows="4" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500" placeholder="Describe the type of jewelry, metal preference, stone shapes, etc." required></textarea>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Inspiration Photo</label>
          ...
          <button
            ...
            class="w-full bg-primary-800 text-white font-bold py-4 rounded-lg shadow-lg hover:shadow-xl transition-all uppercase tracking-wider disabled:opacity-50"
          >
