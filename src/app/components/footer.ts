          ...
          <div class="max-w-md">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
              <input
                ...
                class="flex-1 px-4 py-2.5 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gold-500 w-full"
              />
              <button class="btn-primary px-6 w-full sm:w-auto">Subscribe</button>
            </div>
          </div>
        </div>
