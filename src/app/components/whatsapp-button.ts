...
@Component({
  ...
  template: `
    ...
    <a
      ...
      class="fixed bottom-36 right-4 md:right-6 md:bottom-28 z-40 group font-sans"
      aria-label="Contact us on WhatsApp"
    >
      <!-- Main Button (WhatsApp brand green) -->
      <span
        class="w-12 h-12 md:w-16 md:h-16 bg-[#25D366] group-hover:bg-[#1DA851] rounded-full shadow-2xl transition-all duration-300 flex items-center justify-center transform group-hover:scale-110"
      >
        <svg class="w-7 h-7 md:w-10 md:h-10 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path
    ...
    >
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h3 class="font-display font-semibold text-xl tracking-tight text-[#1d1d1f] mb-1">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#25D366] hover:bg-[#1DA851] text-white text-sm font-medium rounded-full transition-colors duration-200 active:scale-[0.95]"
          >
